...
int buffer_pblk[N_BANKS][N_BUFFERS][SECTORS_PER_PAGE]; // 1섹터==int, 8섹터짜리 페이지들이 뱅크당. 각 버퍼는 페이지크기.
int buffer_isValid[N_BANKS][N_BUFFERS][SECTORS_PER_PAGE]; // Buffer는 1섹터마다 Valid 여부를 별도로 관리
int next_buffer_ppn[N_BANKS];
