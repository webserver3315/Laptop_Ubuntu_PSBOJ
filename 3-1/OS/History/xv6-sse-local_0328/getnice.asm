...
_getnice:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  2b:	e8 4b 03 00 00       	call   37b <getnice>
//	printf(3,"getnice returned %d\n",ret);
	return ret;
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb d3 07 00 00       	mov    $0x7d3,%ebx
        while(*s != 0){
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
