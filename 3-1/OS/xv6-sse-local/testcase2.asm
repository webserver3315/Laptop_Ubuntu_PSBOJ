...
_testcase2:     file format elf32-i386
...
int main(int argc, char **argv)
{
  ...
  12:	83 ec 0c             	sub    $0xc,%esp
		printf(1, "=== TEST START ===\n");
  15:	68 65 08 00 00       	push   $0x865
  1a:	6a 01                	push   $0x1
  1c:	e8 cf 04 00 00       	call   4f0 <printf>
		test_p1_2();
  21:	e8 1a 00 00 00       	call   40 <test_p1_2>
		printf(1, "=== TEST   END ===\n");
  26:	58                   	pop    %eax
  27:	5a                   	pop    %edx
  28:	68 79 08 00 00       	push   $0x879
  2d:	6a 01                	push   $0x1
  2f:	e8 bc 04 00 00       	call   4f0 <printf>

		exit();
  34:	e8 2a 03 00 00       	call   363 <exit>
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop
...
00000040 <test_p1_2>:
{
  ...
  47:	83 ec 08             	sub    $0x8,%esp
	int pid = getpid();
  4a:	e8 94 03 00 00       	call   3e3 <getpid>
	printf(1, "1st pid: %d\n", pid);	
  ...
  5a:	e8 91 04 00 00       	call   4f0 <printf>
	pid = fork();
  5f:	e8 f7 02 00 00       	call   35b <fork>
	if(pid == 0){	//child
  ...
  6b:	74 53                	je     c0 <test_p1_2+0x80>
			for ( z = 0; z < 3000000.0; z += 0.1 )
  6d:	dd 05 90 08 00 00    	fldl   0x890
  73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  77:	90                   	nop
  78:	dc c1                	fadd   %st,%st(1)
  7a:	d9 05 98 08 00 00    	flds   0x898
  80:	df f2                	fcomip %st(2),%st
  82:	77 f4                	ja     78 <test_p1_2+0x38>
  84:	dd d8                	fstp   %st(0)
  86:	dd d8                	fstp   %st(0)
			ps();
  88:	e8 9e 03 00 00       	call   42b <ps>
			yield();
  8d:	e8 91 03 00 00       	call   423 <yield>
			for ( z = 0; z < 3000000.0; z += 0.1 )
  92:	d9 ee                	fldz   
  94:	dd 05 90 08 00 00    	fldl   0x890
  9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  a0:	dc c1                	fadd   %st,%st(1)
  a2:	d9 05 98 08 00 00    	flds   0x898
  a8:	df f2                	fcomip %st(2),%st
  aa:	77 f4                	ja     a0 <test_p1_2+0x60>
  ac:	dd d8                	fstp   %st(0)
  ae:	dd d8                	fstp   %st(0)
			ps();
  b0:	e8 76 03 00 00       	call   42b <ps>
			yield();
  b5:	e8 69 03 00 00       	call   423 <yield>
}
  ba:	c9                   	leave  
		wait();
  bb:	e9 ab 02 00 00       	jmp    36b <wait>
			for ( z = 0; z < 3000000.0; z += 0.1 )
  c0:	dc 05 90 08 00 00    	faddl  0x890
  c6:	d9 05 98 08 00 00    	flds   0x898
  cc:	df f1                	fcomip %st(1),%st
  ce:	77 f0                	ja     c0 <test_p1_2+0x80>
  d0:	dd d8                	fstp   %st(0)
			ps();
  d2:	e8 54 03 00 00       	call   42b <ps>
			yield();
  d7:	e8 47 03 00 00       	call   423 <yield>
			for ( z = 0; z < 3000000.0; z += 0.1 )
  dc:	d9 ee                	fldz   
  de:	dc 05 90 08 00 00    	faddl  0x890
  e4:	d9 05 98 08 00 00    	flds   0x898
  ea:	df f1                	fcomip %st(1),%st
  ec:	77 f0                	ja     de <test_p1_2+0x9e>
  ee:	dd d8                	fstp   %st(0)
			ps();
  f0:	e8 36 03 00 00       	call   42b <ps>
			yield();
  f5:	e8 29 03 00 00       	call   423 <yield>
		exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 9c 08 00 00       	mov    $0x89c,%ebx
        while(*s != 0){
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 70 0b 00 00       	mov    %eax,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 70 0b 00 00       	mov    0xb70,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 842:	00 00 00 
    if(p->s.size >= nunits){
