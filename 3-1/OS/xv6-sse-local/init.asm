...
main(void)
{
  ...
  f9:	6a 01                	push   $0x1
  fb:	6a 01                	push   $0x1
  fd:	68 78 08 00 00       	push   $0x878
 102:	e8 c4 02 00 00       	call   3cb <mknod>
    open("console", O_RDWR);
 107:	5b                   	pop    %ebx
 108:	58                   	pop    %eax
 109:	6a 02                	push   $0x2
 10b:	68 78 08 00 00       	push   $0x878
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb 17 09 00 00       	mov    $0x917,%ebx
        while(*s != 0){
