...
_testcfs2:     file format elf32-i386
...
int main(int argc, char **argv)
{
  ...
  26:	58                   	pop    %eax
  27:	5a                   	pop    %edx
  28:	68 fc 08 00 00       	push   $0x8fc
  2d:	6a 01                	push   $0x1
  2f:	e8 4c 05 00 00       	call   580 <printf>
      exit();
  34:	e8 ba 03 00 00       	call   3f3 <exit>
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop
...
00000040 <testcfs>:
{
  ...
  48:	83 ec 04             	sub    $0x4,%esp
   int parent = getpid();
  4b:	e8 23 04 00 00       	call   473 <getpid>
  50:	89 c3                	mov    %eax,%ebx
   if((child = fork()) == 0) { // child      // if you set parent's priority lower than child, 
  52:	e8 94 03 00 00       	call   3eb <fork>
  57:	85 c0                	test   %eax,%eax
  59:	75 44                	jne    9f <testcfs+0x5f>
      if((child2=fork())==0){ // child's child
  5b:	e8 8b 03 00 00       	call   3eb <fork>
         for ( z = 0; z < 3000.0; z += 0.1 )
  60:	dd 05 10 09 00 00    	fldl   0x910
      if((child2=fork())==0){ // child's child
  66:	89 c2                	mov    %eax,%edx
  68:	b8 64 00 00 00       	mov    $0x64,%eax
  6d:	85 d2                	test   %edx,%edx
  6f:	0f 85 93 00 00 00    	jne    108 <testcfs+0xc8>
  75:	8d 76 00             	lea    0x0(%esi),%esi
         for ( z = 0; z < 3000.0; z += 0.1 )
  78:	d9 ee                	fldz   
  7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  80:	d8 c1                	fadd   %st(1),%st
  82:	d9 05 18 09 00 00    	flds   0x918
  88:	df f1                	fcomip %st(1),%st
  8a:	77 f4                	ja     80 <testcfs+0x40>
  8c:	dd d8                	fstp   %st(0)
      for(i = 0; i < 100; i++){
  8e:	83 e8 01             	sub    $0x1,%eax
  91:	75 e5                	jne    78 <testcfs+0x38>
  93:	dd d8                	fstp   %st(0)
      ps();
  95:	e8 21 04 00 00       	call   4bb <ps>
      exit();
  9a:	e8 54 03 00 00       	call   3f3 <exit>
	setnice(child,5);
  9f:	83 ec 08             	sub    $0x8,%esp
  a2:	6a 05                	push   $0x5
  a4:	50                   	push   %eax
  a5:	e8 f9 03 00 00       	call   4a3 <setnice>
      if((child3=fork())==0){ // parent's child
  aa:	e8 3c 03 00 00       	call   3eb <fork>
  af:	83 c4 10             	add    $0x10,%esp
  b2:	85 c0                	test   %eax,%eax
  b4:	0f 84 9a 00 00 00    	je     154 <testcfs+0x114>
         setnice(child3,2);
  ba:	83 ec 08             	sub    $0x8,%esp
  bd:	6a 02                	push   $0x2
  bf:	50                   	push   %eax
  c0:	e8 de 03 00 00       	call   4a3 <setnice>
         for ( z = 0; z < 3000.0; z += 0.1 )
  c5:	dd 05 10 09 00 00    	fldl   0x910
         setnice(child3,2);
  cb:	83 c4 10             	add    $0x10,%esp
  ce:	b8 64 00 00 00       	mov    $0x64,%eax
  d3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  d7:	90                   	nop
         for ( z = 0; z < 3000.0; z += 0.1 )
  d8:	d9 ee                	fldz   
  da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  e0:	d8 c1                	fadd   %st(1),%st
  e2:	d9 05 18 09 00 00    	flds   0x918
  e8:	df f1                	fcomip %st(1),%st
  ea:	77 f4                	ja     e0 <testcfs+0xa0>
  ec:	dd d8                	fstp   %st(0)
      for(i = 0; i < 100; i++){
  ee:	83 e8 01             	sub    $0x1,%eax
  f1:	75 e5                	jne    d8 <testcfs+0x98>
  f3:	dd d8                	fstp   %st(0)
      ps();
  f5:	e8 c1 03 00 00       	call   4bb <ps>
      wait();
  fa:	e8 fc 02 00 00       	call   3fb <wait>
}
  ff:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 102:	c9                   	leave  
   wait();
 103:	e9 f3 02 00 00       	jmp    3fb <wait>
 108:	dd d8                	fstp   %st(0)
         setnice(child2,-1);
 10a:	83 ec 08             	sub    $0x8,%esp
 10d:	6a ff                	push   $0xffffffff
 10f:	52                   	push   %edx
 110:	e8 8e 03 00 00       	call   4a3 <setnice>
         for ( z = 0; z < 3000.0; z += 0.1 )
 115:	dd 05 10 09 00 00    	fldl   0x910
         setnice(child2,-1);
 11b:	83 c4 10             	add    $0x10,%esp
 11e:	b8 64 00 00 00       	mov    $0x64,%eax
 123:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 127:	90                   	nop
         for ( z = 0; z < 3000.0; z += 0.1 )
 128:	d9 ee                	fldz   
 12a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 130:	d8 c1                	fadd   %st(1),%st
 132:	d9 05 18 09 00 00    	flds   0x918
 138:	df f1                	fcomip %st(1),%st
 13a:	77 f4                	ja     130 <testcfs+0xf0>
 13c:	dd d8                	fstp   %st(0)
      for(i = 0; i < 100; i++){
 13e:	83 e8 01             	sub    $0x1,%eax
 141:	75 e5                	jne    128 <testcfs+0xe8>
 143:	dd d8                	fstp   %st(0)
      ps();
 145:	e8 71 03 00 00       	call   4bb <ps>
      wait();
 14a:	e8 ac 02 00 00       	call   3fb <wait>
      exit();
 14f:	e8 9f 02 00 00       	call   3f3 <exit>
         setnice(parent,-3);
 154:	50                   	push   %eax
 155:	50                   	push   %eax
 156:	6a fd                	push   $0xfffffffd
 158:	53                   	push   %ebx
 159:	e8 45 03 00 00       	call   4a3 <setnice>
 15e:	83 c4 10             	add    $0x10,%esp
 161:	b8 64 00 00 00       	mov    $0x64,%eax
         for ( z = 0; z < 3000.0; z += 0.1 )
 166:	d9 ee                	fldz   
 168:	dc 05 10 09 00 00    	faddl  0x910
 16e:	d9 05 18 09 00 00    	flds   0x918
 174:	df f1                	fcomip %st(1),%st
 176:	77 f0                	ja     168 <testcfs+0x128>
 178:	dd d8                	fstp   %st(0)
      for(i = 0; i < 100; i++){
 17a:	83 e8 01             	sub    $0x1,%eax
 17d:	75 e7                	jne    166 <testcfs+0x126>
 17f:	e9 11 ff ff ff       	jmp    95 <testcfs+0x55>
...
00000580 <printf>:
 ...
 706:	bb 1c 09 00 00       	mov    $0x91c,%ebx
...
00000750 <free>:
 ...
 754:	55                   	push   %ebp
 755:	a1 f4 0b 00 00       	mov    0xbf4,%eax
 ...
 7a1:	5b                   	pop    %ebx
 7a2:	a3 f4 0b 00 00       	mov    %eax,0xbf4
 7a7:	5e                   	pop    %esi
 7a8:	5f                   	pop    %edi
 7a9:	5d                   	pop    %ebp
 7aa:	c3                   	ret    
...
000007e0 <malloc>:
 ...
 7f0:	8b 3d f4 0b 00 00    	mov    0xbf4,%edi
 ...
 839:	8b 3d f4 0b 00 00    	mov    0xbf4,%edi
 ...
 867:	a1 f4 0b 00 00       	mov    0xbf4,%eax
 ...
 897:	a3 f4 0b 00 00       	mov    %eax,0xbf4
 ...
 8b0:	c7 05 f4 0b 00 00 f8 	movl   $0xbf8,0xbf4
 8b7:	0b 00 00 
 8ba:	bf f8 0b 00 00       	mov    $0xbf8,%edi
 8bf:	c7 05 f8 0b 00 00 f8 	movl   $0xbf8,0xbf8
 8c6:	0b 00 00 
 8c9:	89 f8                	mov    %edi,%eax
 8cb:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 8d2:	00 00 00 
